...
export const siteConfig = {
  ...
  useGradient: false,
  themeColors: ["#3a7bd5", "#00d2ff", "#4e54c8", "#8f94fb"], // 呼吸流动的颜色组合
// 修改这里：变成图片数组
  bgImages: ["/bg/bg1.jpg", "/bg/bg2.jpg", "/bg/bg3.jpg"],

  // 4. 文章默认封面图 (当 Markdown 没写 cover 时显示)
  defaultPostCover: "/covers/default.jpg",
  ...
  chatterDescription: "代码、折腾与生活里的碎片记录",


  // 👇 【新增】：全局背景弹幕配置
  danmakuList: ["在干嘛呢？", "有笨蛋嘛？", "前方高能反应！", "今天写代码了吗？", "BUG 修复进度 99%", "Tailwind CSS 拯救前端", "写算法中", "摸鱼中", "到底在干嘛？", "记得喝水哦"],
  gitalkConfig: {
    clientID: "",
    clientSecret: "",
    repo: "",
  ...
  friendLinkApplyFormat: "名称：博客\n简介：在这里记录代码、折腾与生活里的碎碎念。\n链接：https://513613.qzz.io\n头像：https://513613.qzz.io/avatar.png",
